...
public class CustomerController {
	...
	public CustomerList getCustomers(@RequestParam(value="salesRepId", required=false, defaultValue="") String salesRepId, 
...
//		}
		...
		try{
			CustomerList result = service.getCustomers("somesalesrepid") ;
			return result;
		} catch (Exception e){
			try {
